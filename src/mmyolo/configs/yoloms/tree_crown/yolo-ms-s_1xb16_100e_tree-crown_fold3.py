...
train_dataloader = dict(
    ...
    dataset=dict(
        data_root=data_root,
        metainfo=metainfo,
        ann_file='annotations/fold_3/instances_train.json',  # anotações do fold 3
...
val_dataloader = dict(
    ...
    dataset=dict(
        data_root=data_root,
        metainfo=metainfo,
        ann_file='annotations/fold_3/instances_val.json',    # anotações de validação
...
test_dataloader = dict(
    ...
    dataset=dict(
        data_root=data_root,
        metainfo=metainfo,
        ann_file='annotations/fold_3/instances_test.json',     # anotações de teste
        data_prefix=dict(img='rgb/'),
        test_mode=True
    )
)
