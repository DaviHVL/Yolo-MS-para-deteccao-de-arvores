...
train_dataloader = dict(
    ...
    dataset=dict(
        data_root=data_root,
        metainfo=metainfo,
        ann_file='annotations/fold_2/instances_train.json',  # anotações do fold 2
...
val_dataloader = dict(
    ...
    dataset=dict(
        data_root=data_root,
        metainfo=metainfo,
        ann_file='annotations/fold_2/instances_val.json',    # anotações de validação
...
test_dataloader = dict(
    ...
    dataset=dict(
        data_root=data_root,
        metainfo=metainfo,
        ann_file='annotations/fold_2/instances_test.json',    # anotações de teste
        data_prefix=dict(img='rgb/'),
        test_mode=True
    )
)
...
val_evaluator = dict(
    ...
    ann_file=data_root + 'annotations/fold_2/instances_val.json',
...
test_evaluator = dict(
    type='mmdet.CocoMetric',
    ann_file=data_root + 'annotations/fold_2/instances_test.json',
    metric='bbox',
    format_only=False,
    classwise=True,
)
